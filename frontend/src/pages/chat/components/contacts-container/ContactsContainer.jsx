...
const ContactsContainer = () => {
    ...
    useEffect(() => {
       const getContacts = async () => {
         const response = await axiosClient.get(GET_DM_CONTACTS_ROUTE,{
    ...
    return (
        <div className="relative md:w-[35vw] lg:[38vw] xl:[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full">
            <div className="pt-3">
                <Logo />
            </div>
            <div className="my-5">
...
const Title = ({text}) => {
    return (
        <div className="uppercase tracking-widest text-neutral-400 pl-10 font-light text-opacity-90 txt-sm ">{text}</div>
    );
}
